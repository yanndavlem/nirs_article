%% Importer les donn�es + mettre les chemins pour les toolbox
...
job.AddShortSepRegressors_no_pca = 1; % D�cide de prendre ou non le signal des shorts channels (0 : non / 1 : oui)
...
a = sub_stats(i).table;
writetable(a,['H:/Autres ordinateurs/Mon ordinateur/Yann/Data Analyse/1. Analyse NIRS Toolbox/Analyse_TPP/Analyse CRNL/1. Script pour figure papier/V vs A R Analyses/OLS_trial_block_no_PCA_V2/suj_' num2str(i) '_all_sc_no_PCA_V2.csv'],'Delimiter',',')
end
