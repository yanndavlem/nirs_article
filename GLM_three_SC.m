classdef GLM_three_SC < nirs.modules.AbstractGLM
    ...
    properties
        type;
        AddShortSepRegressors_three_SC = false;
        useGPU=false;
    ...
    methods
        function obj = GLM_three_SC( prevJob )
        ...
        function S = runThis( obj, data )
            ...
            if (obj.AddShortSepRegressors_three_SC)
                
                j=nirs.modules.AddShortSeperationRegressors_three_SC();
                j.scICA = 0;
