classdef GLM_no_pca < nirs.modules.AbstractGLM
    ...
    properties
        type;
        AddShortSepRegressors_no_pca = false;
        useGPU=false;
        precisionSingle=false;
        options;
    end
    methods
        function obj = GLM_no_pca( prevJob )
        ...
        function S = runThis( obj, data )
            ...
            if (obj.AddShortSepRegressors_no_pca)
                
                j=nirs.modules.AddShortSeperationRegressors_no_pca();
