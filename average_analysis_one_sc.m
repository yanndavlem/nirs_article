...
for nxn = 1:length(lc_idx)
    ...
    job.AddShortSepRegressors= 0; % Décide de prendre ou non le signal des shorts channels (0 : non / 1 : oui)
...
writetable(r_table_average_with_sc,'H:/Autres ordinateurs/Mon ordinateur/Yann/Data Analyse/1. Analyse NIRS Toolbox/Analyse_TPP/Analyse CRNL/1. Script pour figure papier/V vs A R Analyses/Average_trial_block_one_sc/r_table_average_one_sc.csv','Delimiter',',')
