classdef GLM_corr_three_SC < nirs.modules.AbstractGLM
    ...
    properties
        type;
        AddShortSepRegressors_corr_three_SC = false;
        useGPU=false;
    ...
    methods
        function obj = GLM_corr_three_SC( prevJob )
        ...
        function S = runThis( obj, data )
            ...
            if (obj.AddShortSepRegressors_corr_three_SC)
                
                j=nirs.modules.AddShortSeperationRegressors_corr_three_SC();
                j.scICA = 0;
                j.whichSC = obj.whichSC;
