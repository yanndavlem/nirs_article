...
plots_average(average,'hbo',[-20 20],"HbO average without SC correction");
...
for i = 1:size(sub_stats,2)
    ...
    data_sc_PCA = extract_sc_no_PCA(data_cor(i));
...
writetable(r_table_average_with_sc,'H:/Autres ordinateurs/Mon ordinateur/Yann/Data Analyse/1. Analyse NIRS Toolbox/Analyse_TPP/Analyse CRNL/1. Script pour figure papier/V vs A R Analyses/Average_trial_block_with_sc_no_pca/r_table_average_with_sc_no_pca_V2.csv','Delimiter',',')
