classdef GLM_mean_three_sc < nirs.modules.AbstractGLM
    ...
    properties
        type;
        AddShortSepRegressors_mean_three_sc = false;
        useGPU=false;
    ...
    methods
        ...
        function S = runThis( obj, data )
            ...
            if (obj.AddShortSepRegressors_mean_three_sc)
                
                j=nirs.modules.AddShortSeperationRegressors_mean_three_sc();
