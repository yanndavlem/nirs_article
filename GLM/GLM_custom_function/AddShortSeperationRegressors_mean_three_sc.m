classdef AddShortSeperationRegressors_mean_three_sc < nirs.modules.AbstractModule
    ...
    methods
        function obj = AddShortSeperationRegressors_mean_three_sc(prevJob )
            obj.name = 'AddShortSeperationRegressors_mean_three_sc';
            obj.scICA = false;
            if nargin > 0
                obj.prevJob = prevJob;
            end
