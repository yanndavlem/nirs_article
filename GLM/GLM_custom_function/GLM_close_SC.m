classdef GLM_close_SC < nirs.modules.AbstractGLM
    ...
    properties
        type;
        AddShortSepRegressors_close_SC = false;
        useGPU=false;
    ...
    methods
        ...
        function S = runThis( obj, data )
            ...
            if (obj.AddShortSepRegressors_close_SC)
                
                j=nirs.modules.AddShortSeperationRegressors_close_SC();
                j.scICA = 0;
