...
job.AddShortSepRegressors_mean_sc = 1; % Décide de prendre ou non le signal des shorts channels (0 : non / 1 : oui)
...
a = sub_stats(i).table;
writetable(a,['H:/Autres ordinateurs/Mon ordinateur/Yann/Data Analyse/1. Analyse NIRS Toolbox/Analyse_TPP/Analyse CRNL/1. Script pour figure papier/V vs A R Analyses/OLS_trial_block_mean_all_sc/suj_' num2str(i) '_mean_all_sc.csv'],'Delimiter',',')
end
